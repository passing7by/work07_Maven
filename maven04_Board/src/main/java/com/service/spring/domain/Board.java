 ...
 * 
 * Board와 Member 클래스간의 Relation이 지정되어있음
 * Has a Relation...DI
 */
public class Board {
	...
	private int count;
	private String writeDate; //컬럼명과 다름
	
	private Member member; //Has a Relation -> ResultMap을 어떻게 설정해야 할까?
	...
	public Board(String title, String content, 	String writeDate, Member member) {
		super();
		this.title = title;
		this.content = content;		
		this.writeDate = writeDate;
