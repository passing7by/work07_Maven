...
//		System.out.println("=================================");
		...
		//2
		MyProduct myProduct4 = new MyProduct();
		myProduct4.setName("모래");
		System.out.println("=================================");
		List<MyProduct> list1 = session.selectList(ns+"findProduct", myProduct4);
...
//		System.out.println("=================================");
		...
		MyProduct myProduct5 = new MyProduct();
		myProduct5.setMaker("LG");
		System.out.println("=================================");
		List<MyProduct> list2 = session.selectList(ns+"findProduct", myProduct5);
		for (MyProduct myProduct : list2) {
			System.out.println(myProduct);
		}
		System.out.println("=================================");
		...
		//4
		System.out.println("=================================");
		List<MyProduct> list3 = session.selectList(ns+"findProduct");
